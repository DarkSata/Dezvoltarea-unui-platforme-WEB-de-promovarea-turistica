...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserEntity>().HasData(
            new UserEntity { Id = 1, Username = "admin", Password = "admin123", Role = "admin", Email = null, CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new UserEntity { Id = 2, Username = "user",  Password = "user123",  Role = "user",  Email = null, CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        );

        // ── Seed: Destinations ────────────────────────────────────────────────
        modelBuilder.Entity<DestinationEntity>().HasData(
            new DestinationEntity { Id = "orheiul-vechi", Name = "Orheiul Vechi",       Area = "Orhei",    Cat = "Natura",    Lat = 47.3644, Lng = 28.9784, Description = "Complex natural și archaeological pe malul râului Răut cu mănăstiri rupestre și vestigii medievale.", Tips = "Vizitați dimineața devreme pentru a evita aglomerația. Purtați pantofi comozi.", Image = "/images/destinatii/orheiul-vechi.jpg" },
            new DestinationEntity { Id = "milestii-mici", Name = "Mileștii Mici",       Area = "Ialoveni", Cat = "Vin",       Lat = 46.9333, Lng = 28.9000, Description = "Cel mai mare depozit de vinuri din lume (Guinness). Tunelele subterane au peste 200 km.", Tips = "Rezervați vizita în avans. Turul se face cu mașina proprie sau cu vehiculele vinăriei.", Image = "/images/destinatii/milestii-mici.jpg" },
            new DestinationEntity { Id = "saharna",        Name = "Mănăstirea Saharna", Area = "Rezina",   Cat = "Manastiri", Lat = 47.6833, Lng = 28.9667, Description = "Complex monastic ortodox înconjurat de păduri și cascade pe malul Nistrului.", Tips = "Respectați codul vestimentar. Traseul spre cascade necesită condiție fizică bună.", Image = "/images/destinatii/saharna.jpg" },
            new DestinationEntity { Id = "soroca",         Name = "Cetatea Soroca",     Area = "Soroca",   Cat = "Istorie",   Lat = 48.1561, Lng = 28.2881, Description = "Singura cetate circulară din Moldova, construită la ordinul lui Ștefan cel Mare.", Tips = "Vizitați și Lumânarea Recunoștinței de pe dealul din spatele cetății.", Image = "/images/destinatii/cetatea-soroca.jpg" },
            new DestinationEntity { Id = "chisinau",       Name = "Chișinău",           Area = "Chișinău", Cat = "Orase",     Lat = 47.0105, Lng = 28.8638, Description = "Capitala Republicii Moldova cu parcuri, muzee, restaurante și viață culturală activă.", Tips = "Vizitați Grădina Publică Ștefan cel Mare și Sfânt și Piața Centrală.", Image = "/images/destinatii/chisinau.jpg" },
            new DestinationEntity { Id = "codrii",         Name = "Rezervația Codrii",  Area = "Strășeni", Cat = "Natura",    Lat = 47.1167, Lng = 28.4167, Description = "Cea mai mare rezervație naturală din Moldova (5.177 ha) cu biodiversitate bogată.", Tips = "Obțineți permisul de acces în avans. Traseele marcate sunt recomandate.", Image = "/images/destinatii/codrii.jpg" },
            new DestinationEntity { Id = "cricova",        Name = "Cricova",            Area = "Cricova",  Cat = "Vin",       Lat = 47.1333, Lng = 28.8667, Description = "Vinărie renumită pentru tunelurile de 120 km săpate în calcar.", Tips = "Rezervați turul cu cel puțin o săptămână înainte în sezonul turistic.", Image = "/images/destinatii/cricova.jpg" },
            new DestinationEntity { Id = "tipova",         Name = "Mănăstirea Tipova",  Area = "Rezina",   Cat = "Manastiri", Lat = 47.7000, Lng = 29.0167, Description = "Cel mai vechi complex monahal din Moldova, săpat în stânca de pe malul Nistrului.", Tips = "Traseul este abrupt. Nu este recomandat pe vreme ploioasă.", Image = "/images/destinatii/tipova.jpg" }
        );
